...
namespace VRTest.UnitTest
{
    ...
    public class NPVControllerTest
    {
            ...
            )
        {
            ...
            NPVPreviousRequest nPVPreviousRequest = null;
            ...
            _npvDataAccessMock.Setup(n => n.GetNPVPreviousRequestBy(It.IsAny<NPVPreviousRequest>()))
                .Returns(Task.FromResult(nPVPreviousRequest));
        ...
        [TestCase(2.5, 1.0, .25, 1000)]
        [TestCase(2.5, 1.0, .5, 1000)]
        public void Post_Given_Request_Has_Been_Made_Before_Returns_Ok(
            double upperLimit
            , double lowerLimit
            , double increment
            , double initialCost
            )
        {
            ...
            var cashFlowSummary = string.Join(", ", request.CashFlow.ToArray());
            NPVPreviousRequest nPVPreviousRequest = new NPVPreviousRequest
            {
                CashFlowsDescription = cashFlowSummary
                ,
                Id = 1
            ...
            nPVPreviousRequest.NPVPreviousResults = npvPreviousResults;
